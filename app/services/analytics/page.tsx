...
const analyticsSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://oneclicksoultions.com.au/services/analytics/#service',
  name: 'Analytics & Reporting',
  description: 'Custom Google Analytics 4 dashboards, conversion tracking, and monthly performance reporting for Australian businesses.',
  url: 'https://oneclicksoultions.com.au/services/analytics/',
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Analytics & Reporting', item: 'https://oneclicksoultions.com.au/services/analytics/' },
    ],
  },
};
