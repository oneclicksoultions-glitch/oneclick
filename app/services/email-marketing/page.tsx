...
export const metadata: Metadata = {
  ...
  keywords: ['email marketing Australia'],
...
const emailMarketingSchema = {
  ...
  '@type': 'Service',
  '@id': 'https://oneclicksoultions.com.au/services/email-marketing/#service',
  name: 'Email Marketing',
  description: 'Automated email sequences and broadcast campaigns with industry-leading open rates for Australian businesses.',
  url: 'https://oneclicksoultions.com.au/services/email-marketing/',
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Email Marketing', item: 'https://oneclicksoultions.com.au/services/email-marketing/' },
    ],
  },
};
...
export default function EmailMarketingPage() {
  return (
    <>
      <JsonLd data={emailMarketingSchema} />
      <ServicePageLayout
